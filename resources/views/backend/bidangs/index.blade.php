@extends('backend.layouts.master', ['title' => 'Data Master Bidang'])
@section('Bidang','Helpdesk')
    ...
    <div class ="section-body">
      ...
      <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
          <a href="{{route('bidangs.create')}}" class="btn btn-icon icon-left btn-primary mr-1"><i class="far fa-edit"></i>Tambah Bidang</a>
          <hr>
          <table class="table table-striped table-bordered table-sm" id="tabel-data">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td width="210px">
                  <form id="data" action="{{ route('bidangs.destroy', $bidang->id) }}" method="post">
                   <a class="btn btn-warning  btn-action mr-1" data-toggle="tooltip" title="Edit" href="{{route('bidangs.edit',$bidang->id)}}"> <i class="fas fa-pencil-alt"></i> </a>
                   {{ csrf_field() }}
                   {{ method_field('delete') }}
